...
/**
 * activity 의 애니메이션 타입 정의
 */
enum class ActivityAnimType(@AnimRes val startInAnim: Int, @AnimRes val startOutAnim: Int, @AnimRes val endInAnim: Int, @AnimRes val endOutAnim: Int) {
