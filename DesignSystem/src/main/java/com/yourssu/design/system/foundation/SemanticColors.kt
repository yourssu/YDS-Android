...
val semanticColors = listOf(
    ...
    ColorCategory("Background", listOf(
        ...
        Color("bgSelected", "gray100 / gray900", R.color.bgSelected),
        Color("bgPressed", "gray100 / gray800", R.color.bgPressed),
    ...
    ColorCategory("Text", listOf(
        Color("textPrimary", "black000 / gray100", R.color.textPrimary),
        Color("textSecondary", "gray900 / gray200", R.color.textSecondary),
        Color("textTertiary", "gray600 / gray600", R.color.textTertiary),
        Color("textDisabled", "gray500 / gray700", R.color.textDisabled),
        Color("textBright", "white000 / white000", R.color.textBright),
        Color("textPointed", "pointColor400 / pointColor300", R.color.textPointed),
        Color("textWarned", "warningRed400 / warningRed300", R.color.textWarned),
    )),
    ColorCategory("Dim", listOf(
        Color("dimNormal", "gray900A30 / gray900A30", R.color.dimNormal),
        Color("dimThick", "gray900A70 / gray900A70", R.color.dimThick),
        Color("dimThickBright", "white000A70 / white000A70", R.color.dimThickBright),
    )),
    ColorCategory("Border", listOf(
        Color("borderThin", "gray100 / gray900", R.color.borderThin),
    ...
    ColorCategory("Button", listOf(
        Color("buttonNormal", "gray700 / gray300", R.color.buttonNormal),
        Color("buttonNormalPressed", "gray600 / gray200", R.color.buttonNormalPressed),
        Color("buttonBG", "gray200 / gray800", R.color.buttonBG),
        Color("buttonEmojiBG", "gray100 / gray900", R.color.buttonEmojiBG),
        Color("buttonBright", "white000 / white000", R.color.buttonBright),
        Color("buttonDisabled", "gray500 / gray600", R.color.buttonDisabled),
        Color("buttonDisabledBG", "gray200 / gray800", R.color.buttonDisabledBG),
        ...
        Color("buttonPointBG", "pointColor050 / pointColorA20", R.color.buttonPointBG),
    ...
    ColorCategory("BottomBar", listOf(
        ...
        Color("bottomBarSelected", "gray800 / gray200", R.color.bottomBarSelected),
    )),
    ColorCategory("inputField", listOf(
        Color("inputFieldNormal", "white000 / black000", R.color.inputFieldNormal),
        Color("inputFieldElevated", "gray100 / gray900", R.color.inputFieldElevated),
    )),
    ColorCategory("Toast", listOf(
        Color("toastBG", "gray700 / gray800", R.color.toastBG),
    )),
    ColorCategory("Tooltip", listOf(
        Color("tooltipPoint", "gray700 / gray700", R.color.tooltipBG),
        Color("tooltipPoint", "pointColor400 / pointColor400", R.color.tooltipPoint),
    )),
    ColorCategory("Pressed", listOf(
        Color("pressed", "black000A10 / black000A10", R.color.pressed),
    )),
